...
print('The next payment will start : ')
print(start_date)
...
while balance > 0:
	...
	print('Interest one month will be: ', balance, ' £')

	balance -= monthly_payment
	print('Substract the payment of the balance: ', balance)
	...
	print('End daty: ',end_date, 'Your balance: ', balance)
	 
	today_of_current_month = calendar.monthrange(end_date.year, end_date.month)[1]
	print('End date of the next month: ', today_of_current_month)
